...
class Bot:
    ...
    async def initialize(self):
        ...
        try:
            ...
            logger.info(f"Конфигурация загружена. Разрешенные пользователи: {self.config.telegram.allowed_user_ids}")
            ...
            if not connection_ok:
                logger.warning("Не удалось подключиться к StashApp. Проверьте настройки.")
            else:
