...
class Database(DatabaseBase):
    ...
    def __init__(self, db_path: str):
        ...
        self.get_last_sent_photo_for_user = (
            self.sent_photos_repo.get_last_sent_photo_for_user
        )
        ...
        # Preferences methods
        self.update_performer_preference = (
        ...
        self.get_blacklisted_performers = (
            self.preferences_repo.get_blacklisted_performers
        )
        self.get_whitelisted_performers = (
            self.preferences_repo.get_whitelisted_performers
        )
        ...
        self.is_threshold_notification_shown = (
            self.preferences_repo.is_threshold_notification_shown
        )
        self.mark_threshold_notification_shown = (
        ...
        self.get_gallery_stats_with_viewed_counts = (
            self.weights_repo.get_gallery_stats_with_viewed_counts
        )
        self.update_gallery_last_selected = (
            self.weights_repo.update_gallery_last_selected
        )

        # Statistics methods
        self.update_gallery_image_count = (
            self.statistics_repo.update_gallery_image_count
        )
        self.get_gallery_statistics = self.statistics_repo.get_gallery_statistics
        self.calculate_negative_percentage = (
            self.statistics_repo.calculate_negative_percentage
        )
        self.get_galleries_needing_update = (
            self.statistics_repo.get_galleries_needing_update
        )
