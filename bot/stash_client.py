...
class StashClient:
    ...
    async def get_random_image_with_retry(
        ...
        return await self._image_service.get_random_image_with_retry(exclude_ids, max_retries)
    ...
    async def get_random_image_from_gallery(
        ...
        return await self._image_service.get_random_image_from_gallery(gallery_id, exclude_ids)
    ...
    async def get_random_image_weighted(
        ...
        return await self._image_service.get_random_image_weighted(
            exclude_ids, blacklisted_performers, blacklisted_galleries,
            whitelisted_performers, whitelisted_galleries, max_retries
        )
    ...
    def get_category_metrics(self, gallery_id: Optional[str] = None) -> dict:
    ...
    def _update_category_metrics(self, gallery_id: str, selected_category: str, actual_category: str, used_fallback: bool = False):
        ...
        self._category_metrics.update_category_metrics(gallery_id, selected_category, actual_category, used_fallback)
