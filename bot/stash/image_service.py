...
class ImageService:
    ...
    async def get_random_image_from_gallery_weighted(
            ...
            try:
                ...
                if images:
                    ...
                    if self.category_metrics:
                        self.category_metrics.update_category_metrics(gallery_id, selected_category, actual_category, used_fallback)
        ...
        if self.category_metrics:
            self.category_metrics.update_category_metrics(gallery_id, selected_category, "none", used_fallback=False)
