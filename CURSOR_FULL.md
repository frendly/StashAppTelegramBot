...
1. **Получение весов всех активных галерей** (с кэшированием 60 сек):
...
2. **Взвешенный случайный выбор:**
   - Вычисляется сумма всех весов
   - Генерируется случайное число от 0 до суммы
   - Галерея выбирается пропорционально её весу
   - Галереи с большим весом выбираются чаще

3. **Получение изображения из выбранной галереи:**
